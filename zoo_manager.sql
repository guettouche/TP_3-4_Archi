...
--
-- Client :  127.0.0.1
-- Généré le :  Ven 31 Mars 2017 à 08:41
...
('73f7b238-a546-4aed-84cc-8049628fe858', 'Tic', 'Chipmunk', 1),
('6417c6f3-546f-4e24-b9bc-cb5c6630948d', 'Tac', 'Chipmunk', 1),
('f057cde6-b326-4ebc-90a5-948b30930033', 'Canine', 'Piranha', 2),
('1c6cef6b-9e47-4b89-923f-35d79acb6613', 'Incisive', 'Piranha', 2),
('06bb50c1-bb7c-48e8-902e-2446de425b18', 'Molaire', 'Piranha', 2),
('a93d6de5-a52b-4aca-bf3d-4f45cccc6eee', 'De lait', 'Piranha', 2),
('752485da-6cb3-400d-b171-fcd0b9ea17e9', 'Guettouche', 'Arapaima-gigas', 3),
('0306d839-308b-4207-9d0f-229b2380a812', 'Alice', 'Arapaima-gigas', 3),
('218d6e39-f73c-439f-96c3-aaa3955f42cb', 'BENZI', 'Arapaima-gigas', 3);
...
ALTER TABLE `cage`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_center_cage` (`id_center`);
